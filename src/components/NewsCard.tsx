...
function NewsCard({ article }: NewsCardProps) {
    ...
    return (
        <div className="news-card group flex h-full flex-col overflow-hidden rounded-xl border border-gray-100 bg-white shadow-md transition-shadow duration-300 hover:shadow-lg" dir="rtl">
            ...
            <div className="flex flex-1 flex-col p-5">
                ...
                <h3 className="mb-2 line-clamp-2 text-lg font-bold leading-tight text-gray-900 transition-colors hover:text-blue-600">
                    <Link to={articlePath}>{article.title || 'بدون عنوان'}</Link>
                </h3>

                <p className="mb-4 line-clamp-3 flex-1 text-sm text-gray-600">{contentText}</p>

                <div className="news-card-footer mt-auto flex flex-row-reverse items-center justify-between border-t border-gray-100 pt-4">
                    <Link
                        to={articlePath}
